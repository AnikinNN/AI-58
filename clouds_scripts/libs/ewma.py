...
def ewma_safe(data, alpha, row_size=None, dtype=None, order='C', out=None):
    """
    ...
    if data.size <= row_size:
        ...
        return ewma(data, alpha, dtype=dtype, order=order, out=out)
    ...
    if trailing_n > 0:
        ...
        ewma(data[-trailing_n:], alpha, offset=out_main_view[-1, -1],
...
def ewma_vectorized_2d(data, alpha, axis=None, offset=None, dtype=None, order='C', out=None):
    ...
    if axis is None or data.ndim < 2:
        ...
        if isinstance(offset, np.ndarray):
            offset = offset[0]
        return ewma(data, alpha, offset, dtype=dtype, order=order,
                               out=out)
